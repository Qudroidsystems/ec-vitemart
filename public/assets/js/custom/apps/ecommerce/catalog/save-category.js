            ...
            if (validator) {
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        var description = document.querySelector('#kt_ecommerce_add_category_description .ql-editor').innerHTML;
                        var status = document.getElementById('kt_ecommerce_add_category_status_select').value;
                        var cover = document.getElementById('category_cover');
