...
@section('content')
    ...
    <div id="kt_app_content" class="app-content  flex-column-fluid ">
        ...
        <div id="kt_app_content_container" class="app-container  container-xxl ">
            ...
            <form id="kt_ecommerce_edit_order_form" class="form d-flex flex-column flex-lg-row"
                data-kt-redirect="{{route('admin-sale-all-orders')}}">
                <!--begin::Aside column-->
                        ...
                        <div class="card-body pt-0">
                            <div class="d-flex flex-column gap-10">
                                ...
                                <div class="fv-row">
                                    ...
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7">Set the payment method.</div>
                                    <!--end::Description-->
                                </div>
                                <!--end::Input group-->
                                {{-- 
                                ...
                                <div class="fv-row">
                                    ...
                                    <input id="kt_ecommerce_edit_order_date" name="order_date"
                                        placeholder="Select a date" class="form-control mb-2" value="{{now()}}" />
                                    <!--end::Editor-->
                                                ...
                                                <div class="d-flex align-items-center"
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <a href="../catalog/edit-product.html"
                                                            class="text-gray-800 text-hover-primary fs-5 fw-bold">{{$product->name}}
                                                            </a>
                                                        <!--end::Title-->

                                                        <!--begin::Price-->
                                                        <div class="fw-semibold fs-7">Price: # <span
                                                                data-kt-ecommerce-edit-order-filter="price">{{$product->retail_price_in_naira }}</span>
                                                        </div>
                                                        <!--end::Price-->

                                                        <!--begin::SKU-->
                                                        <div class="text-muted fs-7">SKU: {{$product->slug}}</div>
                                                        <!--end::SKU-->
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-end pe-5" data-order="{{$product->shelf_quantity}}">
                                                <span class="fw-bold ms-3">{{$product->shelf_quantity}}</span>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                ...
                                <div class="fv-row">
                                    ...
                                    <select class="form-select" data-placeholder="Select an option"
                                        ...
                                        <option value="AM"
                                            ...
                                            Armenia</option>
                                        <option value="AW"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/aruba.svg">Aruba
                                        </option>
                                        <option value="AU"
                                        ...
                                        <option value="BZ"
                                            ...
                                            Belize</option>
                                        <option value="BJ"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/benin.svg">Benin
                                        </option>
                                        <option value="BM"
                                        ...
                                        <option value="CL"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/chile.svg">Chile
                                        </option>
                                        <option value="CN"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/china.svg">China
                                        </option>
                                        <option value="CX"
                                        ...
                                        <option value="EC"
                                            ...
                                            Ecuador</option>
                                        <option value="EG"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/egypt.svg">Egypt
                                        </option>
                                        <option value="SV"
                                        ...
                                        <option value="GA"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/gabon.svg">Gabon
                                        </option>
                                        <option value="GM"
                                        ...
                                        <option value="DE"
                                            ...
                                            Germany</option>
                                        <option value="GH"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/ghana.svg">Ghana
                                        </option>
                                        <option value="GI"
                                        ...
                                        <option value="HT"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/haiti.svg">Haiti
                                        </option>
                                        <option value="VA"
                                        ...
                                        <option value="IS"
                                            ...
                                            Iceland</option>
                                        <option value="IN"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/india.svg">India
                                        </option>
                                        <option value="ID"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/indonesia.svg">
                                            Indonesia</option>
                                        <option value="IR"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/iran.svg">Iran,
                                        ...
                                        <option value="IL"
                                            ...
                                            Israel</option>
                                        <option value="IT"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/italy.svg">Italy
                                        </option>
                                        <option value="JM"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/jamaica.svg">
                                            Jamaica</option>
                                        <option value="JP"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/japan.svg">Japan
                                        </option>
                                        <option value="JE"
                                        ...
                                        <option value="KZ"
                                            ...
                                            Kazakhstan</option>
                                        <option value="KE"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/kenya.svg">Kenya
                                        </option>
                                        <option value="KI"
                                        ...
                                        <option value="LR"
                                            ...
                                            Liberia</option>
                                        <option value="LY"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/libya.svg">Libya
                                        </option>
                                        <option value="LI"
                                        ...
                                        <option value="LU"
                                            ...
                                            Luxembourg</option>
                                        <option value="MO"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/macao.svg">Macao
                                        </option>
                                        <option value="MG"
                                        ...
                                        <option value="MV"
                                            ...
                                            Maldives</option>
                                        <option value="ML"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/mali.svg">Mali
                                        </option>
                                        <option value="MT"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/malta.svg">Malta
                                        </option>
                                        <option value="MH"
                                        ...
                                        <option value="NA"
                                            ...
                                            Namibia</option>
                                        <option value="NR"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/nauru.svg">Nauru
                                        </option>
                                        <option value="NP"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/nepal.svg">Nepal
                                        </option>
                                        <option value="NL"
                                        ...
                                        <option value="NI"
                                            ...
                                            Nicaragua</option>
                                        <option value="NE"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/niger.svg">Niger
                                        </option>
                                        <option value="NG"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/nigeria.svg">
                                            Nigeria</option>
                                        <option value="NU"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/niue.svg">Niue
                                        </option>
                                        <option value="NF"
                                        ...
                                        <option value="NO"
                                            ...
                                            Norway</option>
                                        <option value="OM"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/oman.svg">Oman
                                        </option>
                                        <option value="PK"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/pakistan.svg">
                                            Pakistan</option>
                                        <option value="PW"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/palau.svg">Palau
                                        </option>
                                        <option value="PS"
                                        ...
                                        <option value="PY"
                                            ...
                                            Paraguay</option>
                                        <option value="PE"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/peru.svg">Peru
                                        </option>
                                        <option value="PH"
                                        ...
                                        <option value="PR"
                                            ...
                                            Puerto Rico</option>
                                        <option value="QA"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/qatar.svg">Qatar
                                        </option>
                                        <option value="RO"
                                        ...
                                        <option value="WS"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/samoa.svg">Samoa
                                        </option>
                                        <option value="SM"
                                        ...
                                        <option value="SS"
                                            ...
                                            South Sudan</option>
                                        <option value="ES"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/spain.svg">Spain
                                        </option>
                                        <option value="LK"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/sri-lanka.svg">
                                            Sri Lanka</option>
                                        <option value="SD"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/sudan.svg">Sudan
                                        </option>
                                        <option value="SR"
                                        ...
                                        <option value="TH"
                                            ...
                                            Thailand</option>
                                        <option value="TG"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/togo.svg">Togo
                                        </option>
                                        <option value="TK"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/tokelau.svg">
                                            Tokelau</option>
                                        <option value="TO"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/tonga.svg">Tonga
                                        </option>
                                        <option value="TT"
                                        ...
                                        <option value="YE"
                                            data-kt-select2-country="/metronic8/demo1/assets/media/flags/yemen.svg">Yemen
                                        </option>
                                        <option value="ZM"
    ...
    <script>
        var route = "{{ route('admin-sale-edit-order', ['order' => $order->id]) }}";
