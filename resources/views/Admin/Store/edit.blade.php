...
@section('content')
    ...
    <div id="kt_app_content" class="app-content  flex-column-fluid ">
        ...
        <div id="kt_app_content_container" class="app-container  container-xxl ">
            ...
            <form id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row"
                data-kt-redirect="{{ route('admin-all-stores')}}">
                <!--begin::Aside column-->
                <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                        ...
                        <div class="card-body text-center pt-0">
                            ...
                            <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3"
                                ...
                                <div class="image-input-wrapper w-150px h-150px"
                                    style="background-image: url({{ asset('uploads/' . $store->cover->name . '.' . $store->cover->ext)}}">
                                </div>
                                ...
                                <label
                                    ...
                                    <!--begin::Inputs-->
                                    <input id = "cover" type="file" name="avatar" accept=".png, .jpg, .jpeg" />
                            ...
                            <!--begin::Description-->
                            <div class="text-muted fs-7">Set the store thumbnail image. Only *.png,
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-toolbar">
                                <div class="rounded-circle {{ $store->status == 'active' ? 'bg-success' : 'bg-danger'}} w-15px h-15px"
                        ...
                        <div class="card-body pt-0">
                            ...
                            <!--begin::Description-->
                            <div class="text-muted fs-7">Set the store status.</div>
                            <!--end::Description-->
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <!--begin::Input-->
                            <input id="kt_ecommerce_add_product_categories"
                                name="kt_ecommerce_add_product_categories" class="form-control mb-2"
                                value="@foreach ($store->categories as $c){{$c->name . ', '}}@endforeach" data-whitelist = "@foreach ($categories as $c){{ $c->name . ", "}}@endforeach" />
                            <!--end::Input-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7 mb-7">Add store to categories.</div>
                            <!--end::Description-->
                            <!--end::Input group-->
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <label for="kt_ecommerce_add_product_store_template"
                                class="form-label">Select a theme template</label>
                            ...
                            <div class="text-muted fs-7">Assign a template from your current theme to
                                define how the store is displayed.</div>
                            <!--end::Description-->
                        </div>
                        <!--end::Card body-->
                    </div>
                    ...
                    <ul
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab"
                                href="#kt_ecommerce_add_product_reviews">Details</a>
                        </li>
                        <!--end:::Tab item-->
                    </ul>
                    <!--end:::Tabs-->
                            ...
                            <div class="d-flex flex-column gap-7 gap-lg-10">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <input type="text" id="name" name="store_name"
                                                class="form-control mb-2" placeholder="Store name"
                                                value="{{ $store->name }}" />
                                            <!--end::Input-->
                                        ...
                                        <div class="mb-10 fv-row">
                                            <!--begin::Label-->
                                            <label class="required form-label">Store Address</label>
                                            <!--end::Label-->

                                            <!--begin::Input-->
                                            <input type="text" id="store_address" name="store_address"
                                                class="form-control mb-2" placeholder="Store Addres"
                                                value="{{ $store->physical_address }}" />
                                            <!--end::Input-->

                                            <!--begin::Description-->
                                            <div class="text-muted fs-7">A store address is required and
                                                recommended to be unique.</div>
                                            <!--end::Description-->
                                        </div>
                                        <!--end::Input group-->
                                ...
                                <div class="card card-flush py-4">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <!--begin::Description-->
                                        <div class="text-muted fs-7">Set the store media gallery.</div>
                                        <!--end::Description-->
                                    </div>
                                    <!--end::Card header-->
                                </div>
                                            ...
                                            <div class="card-header pt-7">
                                                ...
                                                <div class="card-toolbar">
                                                    ...
                                                    <button class="btn btn-icon btn-color-gray-400 btn-active-color-primary justify-content-end"
                                                        ...
                                                        <i class="ki-duotone ki-dots-square fs-1 text-gray-300 me-n1"><span class="path1"></span><span
                                            ...
                                            <div class="card-header py-7">
                                                ...
                                                <div class="m-0">
                                                    ...
                                                    <div class="d-flex align-items-center mb-2">
                                                        ...
                                                        <!--begin::Badge-->
                                                        <span class="badge badge-light-danger fs-base">
                                                            <i class="ki-duotone ki-arrow-up fs-5 text-danger ms-n1"><span class="path1"></span><span
                                                                    class="path2"></span></i>
                                                            8.02%
                                                        </span>
                                                        <!--end::Badge-->
                                                ...
                                                <div class="mb-0">
                                                    ...
                                                    <div class="d-flex flex-stack">
                                                        ...
                                                        <div class="d-flex align-items-center me-5">
                                                            ...
                                                            <div class="me-5">
                                                                ...
                                                                <!--begin::Desc-->
                                                                <span class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">Direct link
                                                                    clicks</span>
                                                                <!--end::Desc-->
                                                            </div>
                                                            <!--end::Content-->
                                                    ...
                                                    <div class="d-flex flex-stack">
                                                        ...
                                                        <div class="d-flex align-items-center me-5">
                                                            ...
                                                            <div class="symbol symbol-30px me-5">
                                                                <span class="symbol-label">
                                                                    <i class="ki-duotone ki-tiktok fs-3 text-gray-600"><span class="path1"></span><span
                                                                            class="path2"></span></i>
                                                                </span>
                                                            </div>
                                                            <!--end::Symbol-->
                                                    ...
                                                    <div class="d-flex flex-stack">
                                                        ...
                                                        <div class="d-flex align-items-center me-5">
                                                            ...
                                                            <div class="symbol symbol-30px me-5">
                                                                <span class="symbol-label">
                                                                    <i class="ki-duotone ki-sms fs-3 text-gray-600"><span class="path1"></span><span
                                                                            class="path2"></span></i>
                                                                </span>
                                                            </div>
                                                            <!--end::Symbol-->
                                                    ...
                                                    <div class="d-flex flex-stack">
                                                        ...
                                                        <div class="d-flex align-items-center me-5">
                                                            ...
                                                            <div class="symbol symbol-30px me-5">
                                                                <span class="symbol-label">
                                                                    <i class="ki-duotone ki-icon fs-3 text-gray-600"><span class="path1"></span><span
                                        ...
                                        <div class="card card-flush h-xl-100">
                                            ...
                                            <div class="card-body pt-0">
                                                ...
                                                <div class="m-0">
                                                    ...
                                                    <div class="d-flex flex-stack">
                                                        <!--begin::Flag-->
                                                        <img src="../assets/media/flags/brazil.svg" class="me-4 w-25px" style="border-radius: 4px"
                                                            alt="" />
                                                        <!--end::Flag-->
                                                        ...
                                                        <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                                                            ...
                                                            <div class="me-5">
                                                                ...
                                                                <!--begin::Desc-->
                                                                <span class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">All Social Channels
                                                                </span>
                                                                <!--end::Desc-->
                                                            </div>
                                                            <!--end::Content-->
                                                    ...
                                                    <div class="d-flex flex-stack">
                                                        <!--begin::Flag-->
                                                        <img src="../assets/media/flags/turkey.svg" class="me-4 w-25px" style="border-radius: 4px"
                                                            alt="" />
                                                        <!--end::Flag-->
                                                        ...
                                                        <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                                                            ...
                                                            <div class="me-5">
                                                                ...
                                                                <!--begin::Desc-->
                                                                <span class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">Mailchimp
                                                                    Campaigns</span>
                                                                <!--end::Desc-->
                                                            </div>
                                                            <!--end::Content-->
                                                    ...
                                                    <div class="d-flex flex-stack">
                                                        <!--begin::Flag-->
                                                        <img src="../assets/media/flags/france.svg" class="me-4 w-25px" style="border-radius: 4px"
                                                            alt="" />
                                                        <!--end::Flag-->
                                                        ...
                                                        <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                                                            ...
                                                            <div class="me-5">
                                                                ...
                                                                <!--begin::Desc-->
                                                                <span class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">Impact Radius
                                                                    visits</span>
                                                                <!--end::Desc-->
                                                            </div>
                                                            <!--end::Content-->
                                                    ...
                                                    <div class="d-flex flex-stack">
                                                        <!--begin::Flag-->
                                                        <img src="../assets/media/flags/india.svg" class="me-4 w-25px" style="border-radius: 4px"
                                                            alt="" />
                                                        <!--end::Flag-->
                                                    ...
                                                    <div class="d-flex flex-stack">
                                                        <!--begin::Flag-->
                                                        <img src="../assets/media/flags/sweden.svg" class="me-4 w-25px" style="border-radius: 4px"
                                                            alt="" />
                                                        <!--end::Flag-->
                                            ...
                                            <div class="card-body d-flex align-items-end">
                                                ...
                                                <div class="w-100">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="symbol symbol-30px me-5">
                                                            <span class="symbol-label">
                                                                <i class="ki-duotone ki-rocket fs-3 text-gray-600"><span class="path1"></span><span
                                                                        class="path2"></span></i>
                                                            </span>
                                                        </div>
                                                        <!--end::Symbol-->
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="symbol symbol-30px me-5">
                                                            <span class="symbol-label">
                                                                <i class="ki-duotone ki-abstract-25 fs-3 text-gray-600"><span class="path1"></span><span
                                                                        class="path2"></span></i>
                                                            </span>
                                                        </div>
                                                        <!--end::Symbol-->
                                                    ...
                                                    <div class="text-center pt-8 d-1">
                                                        <a href="../apps/ecommerce/sales/details.html"
                                                            class="text-primary opacity-75-hover fs-6 fw-bold">
                                                            View Store Analytics

                                                            <i class="ki-duotone ki-arrow-right fs-3 text-primary"><span class="path1"></span><span
                                                                    class="path2"></span></i>
                                                        </a>
                                                    </div>
                                                    <!--end::Link-->
    ...
    <script>
        var route = "{{ route('admin-update-store', ['store' => $store->id]) }}";

        var maxFiles = {{ $store->media && sizeof($store->media) < 10 ? 10 - sizeof($store->media) : 0}}

        var upload_route = "{{ route('admin-uploads') }}";
    </script>

    <script src="../../../assets/js/custom/apps/ecommerce/catalog/save-store.js"></script>
