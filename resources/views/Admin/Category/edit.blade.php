...
@section('content')
                        ...
                        <div class="card-body text-center pt-0">
                            ...
                            <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3"
                                ...
                                <div class="image-input-wrapper w-150px h-150px"
                                    style="background-image: url({{ asset('uploads/' . $category->cover)}}">
                                </div>
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-toolbar">
                                <div class="rounded-circle {{ $category->status == 'published' ? 'bg-success' : 'bg-danger'}} w-15px h-15px" id="kt_ecommerce_add_category_status">
                                </div>
                            </div>
                            <!--begin::Card toolbar-->
                        </div>
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div>
                                ...
                                <div id="kt_ecommerce_add_category_description" name="kt_ecommerce_add_category_description"
                                    class="min-h-200px mb-2" value = "{{ $category->description }}"></div>
                                <!--end::Editor-->
    ...
    <script>
        var route = "{{ route('admin-update-category', ['category' => $category->id]) }}";
    </script>
