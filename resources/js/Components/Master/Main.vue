...
<section class="tp-slider-area p-relative z-index-1">
   <div class="tp-slider-active tp-slider-variation swiper-container">
      <div id="carouselCaptions1" class="carousel slide" data-bs-ride="carousel">
         ...
         <div class="carousel-inner">
            ...
            <div class="carousel-item active">
               <div class="tp-slider-item tp-slider-height d-flex align-items-center green-dark-bg">
                  <div class="tp-slider-shape">
                     <img class="tp-slider-shape-1" src="/src/assets/img/slider/shape/slider-shape-1.png" alt="slider-shape">
                     <img class="tp-slider-shape-2" src="/src/assets/img/slider/shape/slider-shape-2.png" alt="slider-shape">
                     <img class="tp-slider-shape-3" src="/src/assets/img/slider/shape/slider-shape-3.png" alt="slider-shape">
                     <img class="tp-slider-shape-4" src="/src/assets/img/slider/shape/slider-shape-4.png" alt="slider-shape">
                  </div>
                  <div class="container">
                     <div class="row align-items-center">
                        <div class="col-xl-5 col-lg-6 col-md-6">
                           <div class="tp-slider-content p-relative z-index-1">
                              ...
                              <p>Exclusive offer -35% off this week</p>
                              <div class="tp-slider-btn">
                                 <router-link to="/shop" class="tp-btn tp-btn-2 tp-btn-white">Shop Now</router-link>
                              </div>
                           </div>
                        </div>
                        <div class="col-xl-7 col-lg-6 col-md-6">
                           <div class="tp-slider-thumb text-end">
                              <img src="/src/assets/img/slider/slider-img-1.png" alt="slider-img">
                           </div>
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="row align-items-center">
                        <div class="col-xl-5 col-lg-6 col-md-6">
                           <div class="tp-slider-content p-relative z-index-1">
                              ...
                              <h3 class="tp-slider-title">The best notebook collection 2024</h3>
                        ...
                        <div class="col-xl-7 col-lg-6 col-md-6">
                           <div class="tp-slider-thumb text-end">
                              <img src="/src/assets/img/slider/slider-img-2.png" alt="slider-img">
                           </div>
                        </div>
                     </div>
                  </div>
            ...
            <!-- Slide 3 -->
            <div class="carousel-item">
               <div class="tp-slider-item tp-slider-height d-flex align-items-center" style="background-color: #E3EDF6;">
                  <div class="tp-slider-shape">
                     <img class="tp-slider-shape-1" src="/src/assets/img/slider/shape/slider-shape-1.png" alt="slider-shape">
                     <img class="tp-slider-shape-2" src="/src/assets/img/slider/shape/slider-shape-2.png" alt="slider-shape">
                     <img class="tp-slider-shape-3" src="/src/assets/img/slider/shape/slider-shape-3.png" alt="slider-shape">
                  ...
                  <div class="container">
                     <div class="row align-items-center">
                        ...
                        <div class="col-xl-7 col-lg-6 col-md-6">
                           <div class="tp-slider-thumb text-end">
                              <img src="/src/assets/img/slider/slider-img-3.png" alt="slider-img">
                           </div>
                        </div>
                     </div>
                  </div>
      ...
      <div class="tp-slider-arrow tp-swiper-arrow d-none d-lg-block">
         <button type="button" class="tp-slider-button-prev carousel-control-prev" data-bs-target="#carouselCaptions1" data-bs-slide="prev">
            <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
               <path d="M7 13L1 7L7 1" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>                        
         </button>
         <button type="button" class="tp-slider-button-next carousel-control-next" data-bs-target="#carouselCaptions1" data-bs-slide="next">
            <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="row row-cols-xl-5 row-cols-lg-5 row-cols-md-4">
            ...
            <div class="tp-product-category-item text-center mb-40">
               <div class="tp-product-category-thumb fix">
                  <router-link to="shop-category">
                     <img src="/src/assets/img/product/category/product-cat-1.png" alt="product-category">
                  </router-link>
               </div>
               <div class="tp-product-category-content">
                  <h3 class="tp-product-category-title">
                     <router-link to="shop-category">Headphones</router-link>
                  </h3>
                  <p>20 Product</p>
               </div>
            </div>
         ...
         <div class="col">
            <div class="tp-product-category-item text-center mb-40">
               <div class="tp-product-category-thumb fix">
                  <router-link to="shop-category">
                     <img src="/src/assets/img/product/category/product-cat-2.png" alt="product-category">
                  </router-link>
               </div>
               <div class="tp-product-category-content">
                  <h3 class="tp-product-category-title">
                     <router-link to="shop-category">Mobile Phone</router-link>
                  </h3>
                  <p>25 Product</p>
               </div>
            </div>
         ...
         <div class="col">
            <div class="tp-product-category-item text-center mb-40">
               <div class="tp-product-category-thumb fix">
                  <router-link to="shop-category">
                     <img src="/src/assets/img/product/category/product-cat-3.png" alt="product-category">
                  </router-link>
               </div>
               <div class="tp-product-category-content">
                  <h3 class="tp-product-category-title">
                     <router-link to="shop-category">CPU Heat Pipes</router-link>
                  </h3>
                  <p>57 Product</p>
               </div>
            </div>
         ...
         <div class="col">
            <div class="tp-product-category-item text-center mb-40">
               <div class="tp-product-category-thumb fix">
                  <router-link to="shop-category">
                     <img src="/src/assets/img/product/category/product-cat-4.png" alt="product-category">
                  </router-link>
               </div>
               <div class="tp-product-category-content">
                  <h3 class="tp-product-category-title">
                     <router-link to="shop-category">Smart Watch</router-link>
                  </h3>
                  <p>44 Product</p>
               </div>
            </div>
         ...
         <div class="col">
            <div class="tp-product-category-item text-center mb-40">
               <div class="tp-product-category-thumb fix">
                  <router-link to="shop-category">
                     <img src="/src/assets/img/product/category/product-cat-5.png" alt="product-category">
                  </router-link>
               </div>
               <div class="tp-product-category-content">
                  <h3 class="tp-product-category-title">
                     <router-link to="shop-category">With Bluetooth </router-link>
                  </h3>
                  <p>81 Product</p>
               </div>
            </div>
                     ...
                     <div class="row">
                           ...
                           <div class="tp-product-item p-relative transition-3 mb-25">
                              <div class="tp-product-thumb p-relative fix m-img">
                                 <router-link to="product-details">
                                    <img src="/src/assets/img/product/product-1.jpg" alt="product-electronic">
                                 </router-link>
                              ...
                              <div class="tp-product-content">
                                 <div class="tp-product-category">
                                    <router-link to="shop">Tablet</router-link>
                                 </div>
                        ...
                        <div class="col-xl-3 col-lg-3 col-sm-6">
                           <div class="tp-product-item transition-3 mb-25">
                              <div class="tp-product-thumb p-relative fix m-img">
                                 <router-link to="product-details">
                                    <img src="/src/assets/img/product/product-2.jpg" alt="product-electronic">
                                 </router-link>
                              ...
                              <div class="tp-product-content">
                                 <div class="tp-product-category">
                                    <router-link to="shop">Smart Watch</router-link>
                                 </div>
                                 <h3 class="tp-product-title">
                                    <router-link to="product-details">
                        ...
                        <div class="col-xl-3 col-lg-3 col-sm-6">
                           <div class="tp-product-item transition-3 mb-25">
                              <div class="tp-product-thumb p-relative fix m-img">
                                 <router-link to="product-details">
                                    <img src="/src/assets/img/product/product-3.jpg" alt="product-electronic">
                                 </router-link>
                              ...
                              <div class="tp-product-content">
                                 <div class="tp-product-category">
                                    <router-link to="shop">Headphone</router-link>
                                 </div>
                                 <h3 class="tp-product-title">
                                    <router-link to="product-details">
                        ...
                        <div class="col-xl-3 col-lg-3 col-sm-6">
                           <div class="tp-product-item transition-3 mb-25">
                              <div class="tp-product-thumb p-relative fix m-img">
                                 <router-link to="product-details">
                                    <img src="/src/assets/img/product/product-4.jpg" alt="product-electronic">
                                 </router-link>
                              ...
                              <div class="tp-product-content">
                                 <div class="tp-product-category">
                                    <router-link to="shop">HD Camera</router-link>
                                 </div>
                                 <h3 class="tp-product-title">
                                    <router-link to="product-details">
                        ...
                        <div class="col-xl-3 col-lg-3 col-sm-6">
                           <div class="tp-product-item transition-3 mb-25">
                              <div class="tp-product-thumb p-relative fix m-img">
                                 <router-link to="product-details">
                                    <img src="/src/assets/img/product/product-5.jpg" alt="product-electronic">
                                 </router-link>
                              ...
                              <div class="tp-product-content">
                                 <div class="tp-product-category">
                                    <router-link to="shop">Powerbank</router-link>
                                 </div>
                                 <h3 class="tp-product-title">
                                    <router-link to="product-details">
                        ...
                        <div class="col-xl-3 col-lg-3 col-sm-6">
                           <div class="tp-product-item transition-3 mb-25">
                              <div class="tp-product-thumb p-relative fix m-img">
                                 <router-link to="product-details">
                                    <img src="/src/assets/img/product/product-5-1.jpg" alt="product-electronic">
                                 </router-link>
                              ...
                              <div class="tp-product-content">
                                 <div class="tp-product-category">
                                    <router-link to="shop">Heat Pipes</router-link>
                                 </div>
                                 <h3 class="tp-product-title">
                                    <router-link to="product-details">
                        ...
                        <div class="col-xl-3 col-lg-3 col-sm-6">
                           <div class="tp-product-item transition-3 mb-25">
                              <div class="tp-product-thumb p-relative fix m-img">
                                 <router-link to="product-details">
                                    <img src="/src/assets/img/product/product-5-2.jpg" alt="product-electronic">
                                 </router-link>
                              ...
                              <div class="tp-product-content">
                                 <div class="tp-product-category">
                                    <router-link to="shop">Gaming</router-link>
                                 </div>
                                 <h3 class="tp-product-title">
                                    <router-link to="product-details">
                        ...
                        <div class="col-xl-3 col-lg-3 col-sm-6">
                           <div class="tp-product-item transition-3 mb-25">
                              <div class="tp-product-thumb p-relative fix m-img">
                                 <router-link to="product-details">
                                    <img src="/src/assets/img/product/product-5-3.jpg" alt="product-electronic">
                                 </router-link>
                              ...
                              <div class="tp-product-content">
                                 <div class="tp-product-category">
                                    <router-link to="shop">Backpacks</router-link>
                                 </div>
                                 <h3 class="tp-product-title">
                                    <router-link to="product-details">
      ...
      <div class="row">
         <div class="col-xl-8 col-lg-7">
            <div class="tp-banner-item tp-banner-height p-relative mb-30 z-index-1 fix">
               <div class="tp-banner-thumb include-bg transition-3" style="background-image: url(&quot;/src/assets/img/product/banner/product-banner-1.jpg&quot;);"></div>
               <div class="tp-banner-content">
                  <span>Sale 20% off all store</span>
                  <h3 class="tp-banner-title">
                     <router-link to="product-details">Smartphone <br> BLU G91 Pro 2022</router-link>
                  </h3>
                  <div class="tp-banner-btn">
                     <router-link to="product-details" class="tp-link-btn">Shop Now 
         ...
         <div class="col-xl-4 col-lg-5">
            <div class="tp-banner-item tp-banner-item-sm tp-banner-height p-relative mb-30 z-index-1 fix">
               <div class="tp-banner-thumb include-bg transition-3" style="background-image: url(&quot;/src/assets/img/product/banner/product-banner-2.jpg&quot;);"></div>
               <div class="tp-banner-content">
                  <h3 class="tp-banner-title">
                     <router-link to="product-details">HyperX Cloud II <br> Wireless</router-link>
                  </h3>
                  <p>Sale 35% off</p>
                  <div class="tp-banner-btn">
                     <router-link to="product-details" class="tp-link-btn">Shop Now 
         ...
         <div class="col-xl-8 col-md-7 col-sm-6">
            <div class="tp-product-offer-more-wrapper d-flex justify-content-sm-end p-relative z-index-1">
               <div class="tp-product-offer-more mb-40 text-sm-end grey-bg-2">
                  <router-link to="shop" class="tp-btn tp-btn-2 tp-btn-blue">View All Deals 
      ...
      <div class="row">
         <div class="col-xl-12">
            <div class="tp-product-offer-slider fix">
               <div class="tp-product-offer-slider-active swiper-container swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events">
                  <div class="swiper-wrapper" id="swiper-wrapper-dcced6e104af0bbc4" aria-live="polite" style="transform: translate3d(-1326px, 0px, 0px); transition-duration: 0ms;"><div class="tp-product-offer-item tp-product-item transition-3 swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" data-swiper-slide-index="1" role="group" aria-label="1 / 10" style="width: 412px; margin-right: 30px;">
                        <div class="tp-product-thumb p-relative fix m-img">
                           <router-link to="product-details">
                              <img src="/src/assets/img/product/offer/product-offer-2.jpg" alt="product-electronic">
                           </router-link>
                              ...
                              <div class="tp-product-action-item d-flex flex-column">
                                 <button type="button" class="tp-product-action-btn tp-product-compare-btn">
                                    <svg width="17" height="21" viewBox="0 0 17 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       <path d="M12.6666 1L16 4.33333L12.6666 7.66667" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                       <path d="M1 9.3335V7.66683C1 6.78277 1.35119 5.93493 1.97631 5.30981C2.60143 4.68469 3.44928 4.3335 4.33333 4.3335H16" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                       <path d="M4.33333 19.3332L1 15.9998L4.33333 12.6665" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                       <path d="M16 11V12.6667C16 13.5507 15.6488 14.3986 15.0237 15.0237C14.3986 15.6488 13.5507 16 12.6667 16H1" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                    </svg>                                                  
                        ...
                        <div class="tp-product-content">
                           ...
                           <div class="tp-product-countdown" data-countdown="" data-date="Sep 30 2024 20:20:22">
                              <div class="tp-product-countdown-inner">
                                 <ul>
                                    <li><span data-days="">28</span> Days</li>
                                    <li><span data-hours="">9</span> Hrs</li>
                                    <li><span data-minutes="">0</span> Min</li>
                                    <li><span data-seconds="">44</span> Sec</li>
                                 </ul>
                              </div>
                           </div>

                        </div>
                     </div><div class="tp-product-offer-item tp-product-item transition-3 swiper-slide swiper-slide-duplicate" data-swiper-slide-index="2" role="group" aria-label="2 / 10" style="width: 412px; margin-right: 30px;">
                        <div class="tp-product-thumb p-relative fix m-img">
                           <router-link to="product-details">
                              <img src="/src/assets/img/product/offer/product-offer-3.jpg" alt="product-electronic">
                           </router-link>
                     ...
                     </div><div class="tp-product-offer-item tp-product-item transition-3 swiper-slide swiper-slide-duplicate swiper-slide-prev" data-swiper-slide-index="3" role="group" aria-label="3 / 10" style="width: 412px; margin-right: 30px;">
                        <div class="tp-product-thumb p-relative fix m-img">
                           <router-link to="product-details">
                              <img src="/src/assets/img/product/offer/product-offer-2.jpg" alt="product-electronic">
                           </router-link>
                     ...
                     <div class="tp-product-offer-item tp-product-item transition-3 swiper-slide swiper-slide-active" data-swiper-slide-index="0" role="group" aria-label="4 / 10" style="width: 412px; margin-right: 30px;">
                        <div class="tp-product-thumb p-relative fix m-img">
                           <router-link to="product-details">
                              <img src="/src/assets/img/product/offer/product-offer-1.jpg" alt="product-electronic">
                           </router-link>
                     ...
                     <div class="tp-product-offer-item tp-product-item transition-3 swiper-slide swiper-slide-next" data-swiper-slide-index="1" role="group" aria-label="5 / 10" style="width: 412px; margin-right: 30px;">
                        <div class="tp-product-thumb p-relative fix m-img">
                           <router-link to="product-details">
                              <img src="/src/assets/img/product/offer/product-offer-2.jpg" alt="product-electronic">
                           </router-link>
                     ...
                     <div class="tp-product-offer-item tp-product-item transition-3 swiper-slide" data-swiper-slide-index="2" role="group" aria-label="6 / 10" style="width: 412px; margin-right: 30px;">
                        <div class="tp-product-thumb p-relative fix m-img">
                           <router-link to="product-details">
                              <img src="/src/assets/img/product/offer/product-offer-3.jpg" alt="product-electronic">
                           </router-link>
                     ...
                     <div class="tp-product-offer-item tp-product-item transition-3 swiper-slide swiper-slide-duplicate-prev" data-swiper-slide-index="3" role="group" aria-label="7 / 10" style="width: 412px; margin-right: 30px;">
                        <div class="tp-product-thumb p-relative fix m-img">
                           <router-link to="product-details">
                              <img src="/src/assets/img/product/offer/product-offer-2.jpg" alt="product-electronic">
                           </router-link>
                  ...
                  <div class="tp-product-offer-item tp-product-item transition-3 swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" data-swiper-slide-index="0" role="group" aria-label="8 / 10" style="width: 412px; margin-right: 30px;">
                        <div class="tp-product-thumb p-relative fix m-img">
                           <router-link to="product-details">
                              <img src="/src/assets/img/product/offer/product-offer-1.jpg" alt="product-electronic">
                           </router-link>
                     ...
                     </div><div class="tp-product-offer-item tp-product-item transition-3 swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" data-swiper-slide-index="1" role="group" aria-label="9 / 10" style="width: 412px; margin-right: 30px;">
                        <div class="tp-product-thumb p-relative fix m-img">
                           <router-link to="product-details">
                              <img src="/src/assets/img/product/offer/product-offer-2.jpg" alt="product-electronic">
                           </router-link>
                     ...
                     </div><div class="tp-product-offer-item tp-product-item transition-3 swiper-slide swiper-slide-duplicate" data-swiper-slide-index="2" role="group" aria-label="10 / 10" style="width: 412px; margin-right: 30px;">
                        <div class="tp-product-thumb p-relative fix m-img">
                           <router-link to="product-details">
                              <img src="/src/assets/img/product/offer/product-offer-3.jpg" alt="product-electronic">
                           </router-link>
                  ...
                  <div class="tp-deals-slider-dot tp-swiper-dot text-center mt-40 swiper-pagination-clickable swiper-pagination-bullets"><span class="swiper-pagination-bullet swiper-pagination-bullet-active" tabindex="0"><button>1</button></span><span class="swiper-pagination-bullet" tabindex="0"><button>2</button></span><span class="swiper-pagination-bullet" tabindex="0"><button>3</button></span><span class="swiper-pagination-bullet" tabindex="0"><button>4</button></span></div>
            ...
            <div class="tp-product-gadget-sidebar mb-40">
               <div class="tp-product-gadget-categories p-relative fix mb-10">
                  <div class="tp-product-gadget-thumb">
                     <img src="/src/assets/img/product/gadget/gadget-girl.png" alt="">
                  </div>
                  <h3 class="tp-product-gadget-categories-title">Electronics <br> Gadgets</h3>

                  <div class="tp-product-gadget-categories-list">
                     <ul>
                        <li><router-link to="shop-category">Micrscope</router-link></li>
                        <li><router-link to="shop-category">Remote Control</router-link></li>
                        <li><router-link to="shop-category">Monitor</router-link></li>
                        <li><router-link to="shop-category">Thermometer</router-link></li>
                        <li><router-link to="shop-category">Backpack</router-link></li>
                        <li><router-link to="shop-category">Headphones</router-link></li>
                     </ul>
                  </div>

                  <div class="tp-product-gadget-btn">
                     <router-link to="shop-category" class="tp-link-btn">More Products 
                        <svg width="15" height="13" viewBox="0 0 15 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                           <path d="M13.9998 6.19656L1 6.19656" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                           <path d="M8.75674 0.975394L14 6.19613L8.75674 11.4177" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
               ...
               <div class="tp-product-gadget-banner">
                  <div class="tp-product-gadget-banner-slider-active swiper-container">
                     <div class="swiper-wrapper">
                        <div class="tp-product-gadget-banner-item swiper-slide include-bg" style="background-image: url(&quot;/src/assets/img/product/gadget/gadget-banner-1.jpg&quot;);">
                           <div class="tp-product-gadget-banner-content">
                              ...
                              <h3 class="tp-product-gadget-banner-title">
                                 <router-link to="product-details">Selected novelty <br> Products</router-link>
                              </h3>
                           </div>
                        </div>
                        <div class="tp-product-gadget-banner-item swiper-slide include-bg" style="background-image: url(&quot;/src/assets/img/product/gadget/gadget-banner-2.jpg&quot;);">
                           <div class="tp-product-gadget-banner-content">
                              <span class="tp-product-gadget-banner-price">Only $55.00</span>
                              <h3 class="tp-product-gadget-banner-title">
                                 <router-link to="product-details">Top Rated <br> Products</router-link>
                              </h3>
                           </div>
                        </div>
                     </div>
               ...
               <div class="row">
                  <div class="col-xl-4 col-sm-6">
                     <div class="tp-product-item p-relative transition-3 mb-25">
                        <div class="tp-product-thumb p-relative fix m-img">
                           <router-link to="product-details">
                              <img src="/src/assets/img/product/product-12.jpg" alt="product-electronic">
                           </router-link>
                        ...
                        <div class="tp-product-content">
                           <div class="tp-product-category">
                              <router-link to="shop">Electric</router-link>
                           </div>
                           <h3 class="tp-product-title">
                              <router-link to="product-details">
                  ...
                  <div class="col-xl-4 col-sm-6">
                     <div class="tp-product-item p-relative transition-3 mb-25">
                        <div class="tp-product-thumb p-relative fix m-img">
                           <router-link to="product-details">
                              <img src="/src/assets/img/product/product-13.jpg" alt="product-electronic">
                           </router-link>
                        ...
                        <div class="tp-product-content">
                           <div class="tp-product-category">
                              <router-link to="shop">Tablet Pro 8</router-link>
                           </div>
                           <h3 class="tp-product-title">
                              <router-link to="product-details">
                  ...
                  <div class="col-xl-4 col-sm-6">
                     <div class="tp-product-item p-relative transition-3 mb-25">
                        <div class="tp-product-thumb p-relative fix m-img">
                           <router-link to="product-details">
                              <img src="/src/assets/img/product/product-14.jpg" alt="product-electronic">
                           </router-link>
                  ...
                  <div class="col-xl-4 col-sm-6">
                     <div class="tp-product-item p-relative transition-3 mb-25">
                        <div class="tp-product-thumb p-relative fix m-img">
                           <router-link to="product-details">
                              <img src="/src/assets/img/product/product-15.jpg" alt="product-electronic">
                           </router-link>
                        ...
                        <div class="tp-product-content">
                           <div class="tp-product-category">
                              <router-link to="shop">Pertronix</router-link>
                           </div>
                           <h3 class="tp-product-title">
                              <router-link to="product-details">
                  ...
                  <div class="col-xl-4 col-sm-6">
                     <div class="tp-product-item p-relative transition-3 mb-25">
                        <div class="tp-product-thumb p-relative fix m-img">
                           <router-link to="product-details">
                              <img src="/src/assets/img/product/product-16.jpg" alt="product-electronic">
                           </router-link>
                        ...
                        <div class="tp-product-content">
                           <div class="tp-product-category">
                              <router-link to="shop">Amazon</router-link>
                           </div>
                           <h3 class="tp-product-title">
                              <router-link to="product-details">
                  ...
                  <div class="col-xl-4 col-sm-6">
                     <div class="tp-product-item p-relative transition-3 mb-25">
                        <div class="tp-product-thumb p-relative fix m-img">
                           <router-link to="product-details">
                              <img src="/src/assets/img/product/product-17.jpg" alt="product-electronic">
                           </router-link>
                        ...
                        <div class="tp-product-content">
                           <div class="tp-product-category">
                              <router-link to="shop">Medical</router-link>
                           </div>
                           <h3 class="tp-product-title">
                              <router-link to="product-details">
                     ...
                     <div class="col-xl-6 col-lg-6">
                        <div class="tp-product-banner-content p-relative z-index-1">
                           ...
                           <div class="tp-product-banner-btn">
                              <router-link to="shop" class="tp-btn tp-btn-2">Shop now</router-link>
                           </div>
                        </div>
                     </div>
                     <div class="col-xl-6 col-lg-6">
                        <div class="tp-product-banner-thumb-wrapper p-relative">
                           <div class="tp-product-banner-thumb-shape">
                              ...
                              <img class="tp-offer-shape" src="/src/assets/img/banner/banner-slider-offer.png" alt="">
                           </div>

                           <div class="tp-product-banner-thumb text-end p-relative z-index-1">
                              <img src="/src/assets/img/banner/banner-slider-1.png" alt="">
                           </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="row align-items-center">
                     ...
                     <div class="col-xl-6 col-lg-6">
                        <div class="tp-product-banner-thumb-wrapper p-relative">
                           ...
                           <div class="tp-product-banner-thumb text-end p-relative z-index-1">
                              <img src="/src/assets/img/banner/banner-slider-2.png" alt="">
                           </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="row align-items-center">
                     ...
                     <div class="col-xl-6 col-lg-6">
                        <div class="tp-product-banner-thumb-wrapper p-relative">
                           ...
                           <div class="tp-product-banner-thumb text-end p-relative z-index-1">
                              <img src="/src/assets/img/banner/banner-slider-3.png" alt="">
                           </div>
                        </div>
                     </div>
                  </div>
         ...
         <div class="col-xl-7 col-sm-6">
            <div class="tp-product-arrival-more-wrapper d-flex justify-content-end">
               <div class="tp-product-arrival-arrow tp-swiper-arrow mb-40 text-end tp-product-arrival-border">      
                  <button type="button" class="tp-arrival-slider-button-prev" tabindex="0" aria-label="Previous slide" aria-controls="swiper-wrapper-59ff108f51033a2a4c">
                     <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M7 13L1 7L7 1" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                     </svg>                            
                  </button>             
                  <button type="button" class="tp-arrival-slider-button-next" tabindex="0" aria-label="Next slide" aria-controls="swiper-wrapper-59ff108f51033a2a4c">
                     <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="row">
         <div class="col-xl-12">
            <div class="tp-product-arrival-slider fix">
               <div class="tp-product-arrival-active swiper-container swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events">
                  <div class="swiper-wrapper" id="swiper-wrapper-59ff108f51033a2a4c" aria-live="polite" style="transform: translate3d(-1326px, 0px, 0px); transition-duration: 0ms;"><div class="tp-product-item transition-3 mb-25 swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" data-swiper-slide-index="1" role="group" aria-label="1 / 13" style="width: 301.5px; margin-right: 30px;">
                        <div class="tp-product-thumb p-relative fix m-img">
                           <router-link to="product-details">
                              <img src="/src/assets/img/product/product-7.jpg" alt="product-electronic">
                           </router-link>
                        ...
                        <div class="tp-product-content">
                           <div class="tp-product-category">
                              <router-link to="shop">Earbuds</router-link>
                           </div>
                           <h3 class="tp-product-title">
                              <router-link to="product-details">
                     ...
                     </div><div class="tp-product-item transition-3 mb-25 swiper-slide swiper-slide-duplicate" data-swiper-slide-index="2" role="group" aria-label="2 / 13" style="width: 301.5px; margin-right: 30px;">
                        <div class="tp-product-thumb p-relative fix m-img">
                           <router-link to="product-details">
                              <img src="/src/assets/img/product/product-8.jpg" alt="product-electronic">
                           </router-link>
                     ...
                     </div><div class="tp-product-item transition-3 mb-25 swiper-slide swiper-slide-duplicate" data-swiper-slide-index="3" role="group" aria-label="3 / 13" style="width: 301.5px; margin-right: 30px;">
                        <div class="tp-product-thumb p-relative fix m-img">
                           <router-link to="product-details">
                              <img src="/src/assets/img/product/product-9.jpg" alt="product-electronic">
                           </router-link>
                     ...
                     </div><div class="tp-product-item transition-3 mb-25 swiper-slide swiper-slide-duplicate swiper-slide-prev" data-swiper-slide-index="4" role="group" aria-label="4 / 13" style="width: 301.5px; margin-right: 30px;">
                        <div class="tp-product-thumb p-relative fix m-img">
                           <router-link to="product-details">
                              <img src="/src/assets/img/product/product-10.jpg" alt="product-electronic">
                           </router-link>
                     ...
                     <div class="tp-product-item transition-3 mb-25 swiper-slide swiper-slide-active" data-swiper-slide-index="0" role="group" aria-label="5 / 13" style="width: 301.5px; margin-right: 30px;">
                        <div class="tp-product-thumb p-relative fix m-img">
                           <router-link to="product-details">
                              <img src="/src/assets/img/product/product-6.jpg" alt="product-electronic">
                           </router-link>
                        ...
                        <div class="tp-product-content">
                           <div class="tp-product-category">
                              <router-link to="shop">Fast Charger</router-link>
                           </div>
                           <h3 class="tp-product-title">
                              <router-link to="product-details">
                     ...
                     <div class="tp-product-item transition-3 mb-25 swiper-slide swiper-slide-next" data-swiper-slide-index="1" role="group" aria-label="6 / 13" style="width: 301.5px; margin-right: 30px;">
                        <div class="tp-product-thumb p-relative fix m-img">
                           <router-link to="product-details">
                              <img src="/src/assets/img/product/product-7.jpg" alt="product-electronic">
                           </router-link>
                     ...
                     <div class="tp-product-item transition-3 mb-25 swiper-slide" data-swiper-slide-index="2" role="group" aria-label="7 / 13" style="width: 301.5px; margin-right: 30px;">
                        <div class="tp-product-thumb p-relative fix m-img">
                           <router-link to="product-details">
                              <img src="/src/assets/img/product/product-8.jpg" alt="product-electronic">
                           </router-link>
                     ...
                     <div class="tp-product-item transition-3 mb-25 swiper-slide" data-swiper-slide-index="3" role="group" aria-label="8 / 13" style="width: 301.5px; margin-right: 30px;">
                        <div class="tp-product-thumb p-relative fix m-img">
                           <router-link to="product-details">
                              <img src="/src/assets/img/product/product-9.jpg" alt="product-electronic">
                           </router-link>
                     ...
                     <div class="tp-product-item transition-3 mb-25 swiper-slide swiper-slide-duplicate-prev" data-swiper-slide-index="4" role="group" aria-label="9 / 13" style="width: 301.5px; margin-right: 30px;">
                        <div class="tp-product-thumb p-relative fix m-img">
                           <router-link to="product-details">
                              <img src="/src/assets/img/product/product-10.jpg" alt="product-electronic">
                           </router-link>
                  ...
                  <div class="tp-product-item transition-3 mb-25 swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" data-swiper-slide-index="0" role="group" aria-label="10 / 13" style="width: 301.5px; margin-right: 30px;">
                        <div class="tp-product-thumb p-relative fix m-img">
                           <router-link to="product-details">
                              <img src="/src/assets/img/product/product-6.jpg" alt="product-electronic">
                           </router-link>
                     ...
                     </div><div class="tp-product-item transition-3 mb-25 swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" data-swiper-slide-index="1" role="group" aria-label="11 / 13" style="width: 301.5px; margin-right: 30px;">
                        <div class="tp-product-thumb p-relative fix m-img">
                           <router-link to="product-details">
                              <img src="/src/assets/img/product/product-7.jpg" alt="product-electronic">
                           </router-link>
                     ...
                     </div><div class="tp-product-item transition-3 mb-25 swiper-slide swiper-slide-duplicate" data-swiper-slide-index="2" role="group" aria-label="12 / 13" style="width: 301.5px; margin-right: 30px;">
                        <div class="tp-product-thumb p-relative fix m-img">
                           <router-link to="product-details">
                              <img src="/src/assets/img/product/product-8.jpg" alt="product-electronic">
                           </router-link>
                     ...
                     </div><div class="tp-product-item transition-3 mb-25 swiper-slide swiper-slide-duplicate" data-swiper-slide-index="3" role="group" aria-label="13 / 13" style="width: 301.5px; margin-right: 30px;">
                        <div class="tp-product-thumb p-relative fix m-img">
                           <router-link to="product-details">
                              <img src="/src/assets/img/product/product-9.jpg" alt="product-electronic">
                           </router-link>
               ...
               <div class="tp-product-sm-wrapper mr-20">
                  <div class="tp-product-sm-item d-flex align-items-center">
                     <div class="tp-product-thumb mr-25 fix">
                        <router-link to="product-details">
                           <img src="/src/assets/img/product/sm/product-sm-1.jpg" alt="">
                        </router-link>
                     </div>
                  ...
                  <div class="tp-product-sm-item d-flex align-items-center">
                     <div class="tp-product-thumb mr-25 fix">
                        <router-link to="product-details">
                           <img src="/src/assets/img/product/sm/product-sm-2.jpg" alt="">
                        </router-link>
                     </div>
                     <div class="tp-product-sm-content">
                        <div class="tp-product-category">
                           <router-link to="shop">Iron Man</router-link>
                        </div>
                        <h3 class="tp-product-title">
                           <router-link to="product-details">Single Stem Vase</router-link>
                        </h3>
                        <div class="tp-product-rating d-sm-flex align-items-center">
                           <div class="tp-product-rating-icon">
                              <span><i class="fa-solid fa-star"></i></span>
                  ...
                  <div class="tp-product-sm-item d-flex align-items-center">
                     <div class="tp-product-thumb mr-25 fix">
                        <router-link to="product-details">
                           <img src="/src/assets/img/product/sm/product-sm-3.jpg" alt="">
                        </router-link>
                     </div>
                     <div class="tp-product-sm-content">
                        <div class="tp-product-category">
                           <router-link to="shop">Speaker</router-link>
                        </div>
                        <h3 class="tp-product-title">
                           <router-link to="product-details">Echo Dot smart speaker</router-link>
                        </h3>
                        <div class="tp-product-rating d-sm-flex align-items-center">
                           <div class="tp-product-rating-icon">
                              <span><i class="fa-solid fa-star"></i></span>
            ...
            <div class="tp-product-sm-list mb-50">
               ...
               <div class="tp-product-sm-wrapper mr-20">
                  <div class="tp-product-sm-item d-flex align-items-center">
                     <div class="tp-product-thumb mr-25 fix">
                        <router-link to="product-details">
                           <img src="/src/assets/img/product/sm/product-sm-4.jpg" alt="">
                        </router-link>
                     </div>
                     <div class="tp-product-sm-content">
                        <div class="tp-product-category">
                           <router-link to="shop">Motherboard</router-link>
                        </div>
                        <h3 class="tp-product-title">
                           <router-link to="product-details">CPU Cooler 6 Heat Pipes</router-link>
                        </h3>
                        <div class="tp-product-rating d-sm-flex align-items-center">
                           <div class="tp-product-rating-icon">
                              <span><i class="fa-solid fa-star"></i></span>
                  ...
                  <div class="tp-product-sm-item d-flex align-items-center">
                     <div class="tp-product-thumb mr-25 fix">
                        <router-link to="product-details">
                           <img src="/src/assets/img/product/sm/product-sm-5.jpg" alt="">
                        </router-link>
                     </div>
                     <div class="tp-product-sm-content">
                        <div class="tp-product-category">
                           <router-link to="shop">Digital Camera</router-link>
                        </div>
                        <h3 class="tp-product-title">
                           <router-link to="product-details">Photography Camera</router-link>
                        </h3>
                        <div class="tp-product-rating d-sm-flex align-items-center">
                           <div class="tp-product-rating-icon">
                              <span><i class="fa-solid fa-star"></i></span>
                  ...
                  <div class="tp-product-sm-item d-flex align-items-center">
                     <div class="tp-product-thumb mr-25 fix">
                        <router-link to="product-details">
                           <img src="/src/assets/img/product/sm/product-sm-6.jpg" alt="">
                        </router-link>
                     </div>
                     <div class="tp-product-sm-content">
                        <div class="tp-product-category">
                           <router-link to="shop">Smart Watches</router-link>
                        </div>
                        <h3 class="tp-product-title">
                           <router-link to="product-details">Real-Time Weather.</router-link>
                        </h3>
                        <div class="tp-product-rating d-sm-flex align-items-center">
                           <div class="tp-product-rating-icon">
                              <span><i class="fa-solid fa-star"></i></span>
            ...
            <div class="tp-product-sm-list mb-50">
               ...
               <div class="tp-product-sm-wrapper mr-20">
                  <div class="tp-product-sm-item d-flex align-items-center">
                     <div class="tp-product-thumb mr-25 fix">
                        <router-link to="product-details">
                           <img src="/src/assets/img/product/sm/product-sm-7.jpg" alt="">
                        </router-link>
                     </div>
                     <div class="tp-product-sm-content">
                        <div class="tp-product-category">
                           <router-link to="shop">Usb Flash Disk</router-link>
                        </div>
                        <h3 class="tp-product-title">
                           <router-link to="product-details">Metal Usb 3.0 Pen Drive 2TB</router-link>
                        </h3>
                        <div class="tp-product-rating d-sm-flex align-items-center">
                           <div class="tp-product-rating-icon">
                              <span><i class="fa-solid fa-star"></i></span>
                  ...
                  <div class="tp-product-sm-item d-flex align-items-center">
                     <div class="tp-product-thumb mr-25 fix">
                        <router-link to="product-details">
                           <img src="/src/assets/img/product/sm/product-sm-8.jpg" alt="">
                        </router-link>
                     </div>
                     <div class="tp-product-sm-content">
                        <div class="tp-product-category">
                           <router-link to="shop">HawkEye</router-link>
                        </div>
                        <h3 class="tp-product-title">
                           <router-link to="product-details">HawkEye Fishtrax</router-link>
                        </h3>
                        <div class="tp-product-rating d-sm-flex align-items-center">
                           <div class="tp-product-rating-icon">
                              <span><i class="fa-solid fa-star"></i></span>
                  ...
                  <div class="tp-product-sm-item d-flex align-items-center">
                     <div class="tp-product-thumb mr-25 fix">
                        <router-link to="product-details">
                           <img src="/src/assets/img/product/sm/product-sm-9.jpg" alt="">
                        </router-link>
                     </div>
                     <div class="tp-product-sm-content">
                        <div class="tp-product-category">
                        ...
                        <h3 class="tp-product-title">
                           <router-link to="product-details">Galaxy Tab S6 Android</router-link>
                        </h3>
                        <div class="tp-product-rating d-sm-flex align-items-center">
                           <div class="tp-product-rating-icon">
                              <span><i class="fa-solid fa-star"></i></span>
         ...
         <div class="col-xl-8 col-md-6">
            <div class="tp-blog-more-wrapper d-flex justify-content-md-end">
               <div class="tp-blog-more mb-50 text-md-end">
                  <router-link to="blog-grid" class="tp-btn tp-btn-2 tp-btn-blue">View All Blog 
                     <svg width="17" height="14" viewBox="0 0 17 14" fill="none" xmlns="http://www.w3.org/2000/svg">
               ...
               <div class="tp-blog-main-slider-active swiper-container">
                  <div class="swiper-wrapper">
                     <div class="tp-blog-item mb-30 swiper-slide">
                        ...
                        <div class="tp-blog-content">
                           <h3 class="tp-blog-title">
                              <router-link to="blog-details">The Modern Art Clay Ceramics.</router-link>
                           </h3>
   
                           <div class="tp-blog-tag">
                              <span><i class="fa-light fa-tag"></i></span>
                              <router-link to="#">Tablet,</router-link>
                           ...
                           <div class="tp-blog-btn">
                              <router-link to="blog-details" class="tp-btn-2 tp-btn-border-2">
                                 Read More 
                                 <span>
                     ...
                     <div class="tp-blog-item mb-30 swiper-slide">
                        ...
                        <div class="tp-blog-content">
                           <h3 class="tp-blog-title">
                              <router-link to="blog-details">How clothes are linked to climate</router-link>
                           </h3>
                     ...
                     <div class="tp-blog-item mb-30 swiper-slide">
                        ...
                        <div class="tp-blog-content">
                           <h3 class="tp-blog-title">
                              <router-link to="blog-details">The Sound Of Fashion: Malcolm</router-link>
                           </h3>

                           <div class="tp-blog-tag">
                              <span><i class="fa-light fa-tag"></i></span>
                              <router-link to="#">Microphone,</router-link>
                              <router-link to="#">Computer</router-link>
                           </div>
      ...
      <div class="row row-cols-lg-5 row-cols-md-3 row-cols-sm-2 row-cols-1">
         <div class="col">
            <div class="tp-instagram-item p-relative z-index-1 fix mb-30 w-img">
               <img src="/src/assets/img/instagram/instagram-1.jpg" alt="">
               <div class="tp-instagram-icon">
                  <router-link to="/src/assets/img/instagram/instagram-1.jpg" class="popup-image"><i class="fa-brands fa-instagram"></i></router-link>
               </div>
            </div>
         </div>
         <div class="col">
            <div class="tp-instagram-item p-relative z-index-1 fix mb-30 w-img">
               <img src="/src/assets/img/instagram/instagram-2.jpg" alt="">
               <div class="tp-instagram-icon">
                  <router-link to="/src/assets/img/instagram/instagram-2.jpg" class="popup-image"><i class="fa-brands fa-instagram"></i></router-link>
               </div>
            </div>
         </div>
         <div class="col">
            <div class="tp-instagram-item p-relative z-index-1 fix mb-30 w-img">
               <img src="/src/assets/img/instagram/instagram-3.jpg" alt="">
               <div class="tp-instagram-icon">
                  <router-link to="/src/assets/img/instagram/instagram-3.jpg" class="popup-image"><i class="fa-brands fa-instagram"></i></router-link>
               </div>
            </div>
         </div>
         <div class="col">
            <div class="tp-instagram-item p-relative z-index-1 fix mb-30 w-img">
               <img src="/src/assets/img/instagram/instagram-4.jpg" alt="">
               <div class="tp-instagram-icon">
                  <router-link to="/src/assets/img/instagram/instagram-4.jpg" class="popup-image"><i class="fa-brands fa-instagram"></i></router-link>
               </div>
            </div>
         </div>
         <div class="col">
            <div class="tp-instagram-item p-relative z-index-1 fix mb-30 w-img">
               <img src="/src/assets/img/instagram/instagram-5.jpg" alt="">
               <div class="tp-instagram-icon">
                  <router-link to="/src/assets/img/instagram/instagram-5.jpg" class="popup-image"><i class="fa-brands fa-instagram"></i></router-link>
               </div>
            </div>
         </div>
      </div>
...
<section class="tp-subscribe-area pt-70 pb-65 theme-bg p-relative z-index-1">
   <div class="tp-subscribe-shape">
      <img class="tp-subscribe-shape-1" src="/src/assets/img/subscribe/subscribe-shape-1.png" alt="">
      <img class="tp-subscribe-shape-2" src="/src/assets/img/subscribe/subscribe-shape-2.png" alt="">
      <img class="tp-subscribe-shape-3" src="/src/assets/img/subscribe/subscribe-shape-3.png" alt="">
      <img class="tp-subscribe-shape-4" src="/src/assets/img/subscribe/subscribe-shape-4.png" alt="">
      <!-- plane shape -->
      <div class="tp-subscribe-plane">
         <img class="tp-subscribe-plane-shape" src="/src/assets/img/subscribe/plane.png" alt="">
               ...
               <nav>
                  <div class="nav nav-tabs flex-sm-column " id="productDetailsNavThumb" role="tablist">
                     <button class="nav-link active" id="nav-1-tab" data-bs-toggle="tab" data-bs-target="#nav-1" type="button" role="tab" aria-controls="nav-1" aria-selected="true">
                        <img src="/src/assets/img/product/details/nav/product-details-nav-1.jpg" alt="">
                     </button>
                     <button class="nav-link" id="nav-2-tab" data-bs-toggle="tab" data-bs-target="#nav-2" type="button" role="tab" aria-controls="nav-2" aria-selected="false">
                        <img src="/src/assets/img/product/details/nav/product-details-nav-2.jpg" alt="">
                     </button>
                     <button class="nav-link" id="nav-3-tab" data-bs-toggle="tab" data-bs-target="#nav-3" type="button" role="tab" aria-controls="nav-3" aria-selected="false">
                        <img src="/src/assets/img/product/details/nav/product-details-nav-3.jpg" alt="">
                     </button>
                     <button class="nav-link" id="nav-4-tab" data-bs-toggle="tab" data-bs-target="#nav-4" type="button" role="tab" aria-controls="nav-4" aria-selected="false">
                        <img src="/src/assets/img/product/details/nav/product-details-nav-4.jpg" alt="">
                     </button>
                  </div>
               </nav>
               <div class="tab-content m-img" id="productDetailsNavContent">
                  <div class="tab-pane fade show active" id="nav-1" role="tabpanel" aria-labelledby="nav-1-tab" tabindex="0">
                     <div class="tp-product-details-nav-main-thumb">
                        <img src="/src/assets/img/product/details/main/product-details-main-1.jpg" alt="">
                     </div>
                  </div>
                  <div class="tab-pane fade" id="nav-2" role="tabpanel" aria-labelledby="nav-2-tab" tabindex="0">
                     <div class="tp-product-details-nav-main-thumb">
                        <img src="/src/assets/img/product/details/main/product-details-main-2.jpg" alt="">
                     </div>
                  </div>
                  <div class="tab-pane fade" id="nav-3" role="tabpanel" aria-labelledby="nav-3-tab" tabindex="0">
                     <div class="tp-product-details-nav-main-thumb">
                        <img src="/src/assets/img/product/details/main/product-details-main-3.jpg" alt="">
                     </div>
                  </div>
                  <div class="tab-pane fade" id="nav-4" role="tabpanel" aria-labelledby="nav-4-tab" tabindex="0">
                     <div class="tp-product-details-nav-main-thumb">
                        <img src="/src/assets/img/product/details/main/product-details-main-4.jpg" alt="">
                     </div>
                  </div>
                </div>
            </div>
