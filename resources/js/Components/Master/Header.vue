<style>
    ...
    span.logo {
        ...
        animation-delay: 1s;
        /* Matches the duration of the logo animation */
    }
...
<template>
    ...
    <!-- <div class="tp-preloader-content">
                  <div class="tp-preloader-logo">
                     ...
                     <img src="/src/assets/img/logo/preloader/preloader-icon.svg" alt="">
                  </div>
            ...
            <div class="offcanvas__content">
                <div class="offcanvas__top mb-70 d-flex justify-content-between align-items-center">
                    <div class="offcanvas__logo logo">
                        <router-link to="/" class="vitemart">
                            <span class="logo-img">
                                <img src="/src/assets/img/logo/logo.jpg" alt="logo">
                            </span>
                            <span class="logo roboto-medium">
                                ozakmart
                            </span>
                        </router-link>
                    </div>
                ...
                <div class="offcanvas__contact align-items-center d-none">
                    <div class="offcanvas__contact-icon mr-20">
                        <span>
                            <img src="/src/assets/img/icon/contact.png" alt="">
                        </span>
                    </div>
                    ...
                    <div class="offcanvas__select language">
                        <div class="offcanvas__lang d-flex align-items-center justify-content-md-end">
                            <div class="offcanvas__lang-img mr-15">
                                <img src="/src/assets/img/icon/language-flag.png" alt="">
                            </div>
        ...
        <div class="cartmini__wrapper d-flex justify-content-between flex-column">
            <div class="cartmini__top-wrapper">
                    ...
                    <div class="cartmini__widget-item">
                        <div class="cartmini__thumb">
                            <a href="product-details.html">
                                <img src="/src/assets/img/product/product-1.jpg" alt="">
                            </a>
                        </div>
                ...
                <div class="cartmini__empty text-center d-none">
                    <img src="/src/assets/img/product/cartmini/empty-cart.png" alt="">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-4 col-6">
                            <div class="logo">
                                <router-link to="/" class="vitemart">
                                    ...
                                    <span class="logo roboto-medium playwrite-au-nsw-gozaklogo">
                                        ozakmart
                                    </span>
                                </router-link>
                            </div>
                                    ...
                                    <div class="tp-header-search-wrapper d-flex align-items-center">
                                        ...
                                        <div class="tp-header-search-category">
                                            ...
                                            <div class="nice-select" tabindex="0"><span class="current">Select
                                                    Category</span>
                                                <ul class="list">
                                                    <li data-value="Select Category" class="option selected focus">
                                                        Select Category</li>
                                                    <li data-value="Mobile" class="option">Mobile</li>
                                                    <li data-value="Digital Watch" class="option">Digital Watch</li>
                                                    <li data-value="Computer" class="option">Computer</li>
                ...
                <div class="container">
                    <div class="tp-mega-menu-wrapper p-relative">
                                                ...
                                                <ul class="mega-menu tp-submenu">
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="shop.html"><img
                                                                        src="/src/assets/img/header/menu/menu-1.jpg"
                                                                        alt=""></a>
                                                            </li>
                                                            <li>
                                                    ...
                                                    <li>
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="shop.html"><img
                                                                        src="/src/assets/img/header/menu/menu-2.jpg"
                                                                        alt=""></a>
                                                            </li>
                                                            <li>
                                                    ...
                                                    <li>
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="shop.html"><img
                                                                        src="/src/assets/img/header/menu/menu-3.jpg"
                                                                        alt=""></a>
                                                            </li>
                                                            <li>
                            ...
                            <div class="col-xl-6 col-lg-2">
                                <div class="main-menu menu-style-1">
                                    <nav class="tp-main-menu-content">
                                        <ul>
                                            <li>
                                                <router-link to="/" data-bs-toggle="tooltip" title="Mart">Home
                                                </router-link>
                                            </li>
                                            <li>
                                                <router-link to="/pharmacy">Pharmacy</router-link>
                                            </li>
                                            <!-- <div class="home-menu tp-submenu tp-mega-menu d-flex flex-row">
                     ...
                     <router-link to="/">
                        Mart
                                                      <div class="home-menu-thumb p-relative fix">
                                                         <img src="/src/assets/img/menu/menu-home-1.jpg" alt="">
                                                      </div>
                                                      <div class="home-menu-content">
                                                         <h5 class="home-menu-title">Mart</h5>
                                                      </div>
                     </router-link>
                                                </div>
                                             </div>
                     ...
                     <router-link to="/pharmacy">
                        Pharmacy
                                                      <div class="home-menu-thumb p-relative fix">
                                                         <img src="/src/assets/img/menu/menu-home-2.jpg" alt="">
                                                      </div>
                                                      <div class="home-menu-content">
                                                         <h5 class="home-menu-title">Pharmacy</h5>
                                                      </div>
                     </router-link>
                                                </div>
                                             </div>
                     ...
                     <router-link to="/shop">Shop</router-link>
                                          ...
                                          <div class="row">
                                             <div class="col-lg-2">
                                                <div class="shop-mega-menu-list">
                                                      <router-link to="/shop" class="shop-mega-menu-title">Shop Pages</router-link>
                                                      <ul>
                                                          <li><router-link to="/shop-category">Grid Category</router-link></li>
                                                          <li><router-link to="/shop">Grid Layout</router-link></li>
                                                          <li><router-link to="/shop-list">List Layout</router-link></li>
                                                          <li><router-link to="/shop-masonary">Masonary Layout</router-link></li>
                                                          <li><router-link to="/shop-full-width">Full width Layoutt</router-link></li>
                                                          <li><router-link to="/shop-1600">1600px Layout</router-link></li>
                                                          <li><router-link to="/shop">Left Sidebar</router-link></li>
                                                          <li><router-link to="/shop-right-sidebar">Right Sidebar</router-link></li>
                                                          <li><router-link to="/shop-no-sidebar">Hidden Sidebar</router-link></li>
                                                      </ul>
                                                </div>
                                             </div>
                                             <div class="col-lg-2">
                                                <div class="shop-mega-menu-list">
                                                   <router-link to="/shop" class="shop-mega-menu-title">Features</router-link>
                                                      <ul>
                                                         <li><router-link to="/shop-filter-dropdown">Filter Dropdown</router-link></li>
                                                         <li><router-link to="/shop-filter-offcanvas">Filters Offcanvas</router-link></li>
                                                         <li><router-link to="/shop">Filters Sidebar</router-link></li>
                                                         <li><router-link to="/shop-load-more">Load More button</router-link></li>
                                                         <li><router-link to="/shop-infinite-scroll">Infinit scrolling</router-link></li>
                                                         <li><router-link to="/shop-list">Collections list</router-link></li>
                                                         <li><router-link to="/shop">Hidden search</router-link></li>
                                                         <li><router-link to="/shop">Search Full screen</router-link></li>
                                                      </ul>
                                                </div>
                                             </div>
                                             <div class="col-lg-2">
                                                <div class="shop-mega-menu-list">
                                                      <router-link to="/shop" class="shop-mega-menu-title">Hover Style</router-link>
                                                      <ul>
                                                         <li><router-link to="/shop">Hover Style 1</router-link></li>
                                                         <li><router-link to="/shop">Hover Style 2</router-link></li>
                                                         <li><router-link to="/shop">Hover Style 3</router-link></li>
                                                         <li><router-link to="/shop">Hover Style 4</router-link></li>
                                                      </ul>
                                                </div>
                                             </div>
                                             <div class="col-lg-3">
                                                <div class="shop-mega-menu-img">
                                                   <img src="/src/assets/img/menu/product/menu-product-img-1.jpg" alt="">
                                                   <div class="shop-mega-menu-btn">
                                                      <router-link to="/shop-category" class="tp-menu-showcase-btn tp-menu-showcase-btn-2">Phones</router-link>
                                                   </div>
                                                </div>
                                             </div>
                                             <div class="col-lg-3">
                                                <div class="shop-mega-menu-img">
                                                   <img src="/src/assets/img/menu/product/menu-product-img-2.jpg" alt="">
                                                   <div class="shop-mega-menu-btn">
                                                      <router-link to="/shop-category" class="tp-menu-showcase-btn tp-menu-showcase-btn-2">Cameras</router-link>
                                                   </div>
                                                </div>
                                             </div>
                                          </div>
                                       ...
                                       <ul class="tp-submenu tp-mega-menu mega-menu-style-2">
                                          ...
                                          <li class="has-dropdown">
                                             <router-link to="/shop" class="mega-menu-title">Shop Page</router-link>
                                             <ul class="tp-submenu">
                                                <li><router-link to="/shop-category">Only Categories</router-link></li>
                                                <li><router-link to="/shop-filter-offcanvas">Shop Grid</router-link></li>
                                                <li><router-link to="/shop">Shop Grid with Sideber</router-link></li>
                                                <li><router-link to="/shop-list">Shop list</router-link></li>
                                                <li><router-link to="/shop-category">Categories</router-link></li>
                                                <li><router-link to="/product-details">Product Details</router-link></li>
                                                <li><router-link to="/product-details-progress">Product Details Progress</router-link></li>
                                             </ul>
                                          </li>
                                          <li  class="has-dropdown">
                                             <router-link to="/shop" class="mega-menu-title">eCommerce</router-link>
                                             <ul class="tp-submenu">
                                                <li><router-link to="/cart">Shopping Cart</router-link></li>
                                                <li><router-link to="/order">Track Your Order</router-link></li>
                                          ...
                                          <li  class="has-dropdown">
                                             <router-link to="/shop" class="mega-menu-title">More Pages</router-link>
                                             <ul class="tp-submenu">
                                                <li><router-link to="/about">About</router-link></li>
                                                <li><router-link to="/login">Login</router-link></li>
                                                <li><router-link to="/register">Register</router-link></li>
                                                <li><router-link to="/forgotpassword">Forgot Password</router-link></li>
                                                <li><router-link to="/404-error">404 Error</router-link></li>
                                             </ul>
                                          </li>
                                            ...
                                            <li>
                                                <router-link to="/coupon">Coupons</router-link>
                                            </li>
                                            <!-- <li class="has-dropdown">
                                       <router-link to="/blog">Blog</router-link>
                                       <ul class="tp-submenu">
                                          <li><router-link to="/blog">Blog Standard</router-link></li>
                                          <li><router-link to="/blog-grid">Blog Grid</router-link></li>
                                          <li><router-link to="/blog-list">Blog List</router-link></li>
                                          <li><router-link to="/blog-details-2">Blog Details Full Width</router-link></li>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 d-none d-md-block">
                        <div class="tp-header-sticky-menu main-menu menu-style-1">
                            <nav id="mobile-menu">
                                <ul>
                                    <li>
                                        <router-link to="/" title="Mart">Home</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/pharmacy">Pharmacy</router-link>
                                    </li>
                                    ...
                                    <!-- <li class="has-dropdown has-mega-menu ">
                                                                  ...
                                                                  <ul class="tp-submenu tp-mega-menu mega-menu-style-2">
                                                                     ...
                                                                     <li  class="has-dropdown">
                                                                        <router-link to="/product-details" class="mega-menu-title">Products</router-link>
                                                                        <ul class="tp-submenu">
                                                                           
                                                                           <li><router-link to="/product-details">Product Simple</router-link></li>
                                                                           <li><router-link to="/product-details-video">With Video</router-link></li>
                                                                           <li><router-link to="/product-details-countdown">With Countdown Timer</router-link></li>
                                                                           <li><router-link to="/product-details-presentation">Product Presentation</router-link></li>
                                                                           <li><router-link to="/product-details-swatches">Variations Swatches</router-link></li>
                                                                           <li><router-link to="/product-details-list">List Views</router-link></li>
                                                                           <li><router-link to="/product-details-gallery">Details Gallery</router-link></li>
                                                                           <li><router-link to="/product-details-slider">With Slider</router-link></li>
                                                                        </ul>
                                                                     </li>
                                                                     <li  class="has-dropdown">
                                                                        <router-link to="/shop" class="mega-menu-title">eCommerce</router-link>
