                        ...
                        <div class="tp-footer-widget footer-col-1 mb-50">
                            <div class="tp-footer-widget-content">
                                <div class="tp-footer-logo">
                                    ...
                                    <span class="logo-img">
                                        <img src="/@../../public/assets/img/logo/logo.jpg" alt="logo">
                                    </span>
                                ...
                                <div class="tp-footer-social" style="display: flex; gap:5px;">
                            ...
                            <div class="tp-footer-widget-content">
                                ...
                                <div class="tp-footer-contact">
                                    ...
                                    <div class="tp-footer-contact-content">
                                        <p><a href="https://template.wphix.com/cdn-cgi/l/email-protection#a2d1cacdc4dbe2d1d7d2d2cdd0d68cc1cdcf"><span class="__cf_email__" data-cfemail="80f3e8efe6f9c0f3f5f0f0eff2f4aee3efed">[email&#160;protected]</span></a></p>
                                    </div>
                                    </div>
                                    <div class="tp-footer-contact-item d-flex align-items-start">
                                    <div class="tp-footer-contact-icon">
                    ...
                    <div class="tp-footer-bottom-wrapper">
                        ...
                        <div class="col-md-6">
                            <div class="tp-footer-payment text-md-end">
                                <p>
                                    <img src="@../../public/assets/img/footer/footer-pay.png" alt="">
                                </p>
                            </div>
                        </div>
                        </div>
