                    ...
                    <div class="col-xl-9 col-lg-8">
                        <div class="tp-cart-list mb-25 mr-30">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr v-bind:key = "item.id" v-for="item in cart_items">
                                        <!-- img -->
                                        <td class="tp-cart-img">
                                            <Link href="product-details.html"> <img src="/assets/img/product/cart/product-cart-1.jpg" alt=""></Link>
                                        </td>
                                        <!-- title -->
                                        ...
                                        <!-- price -->
                                        <td class="tp-cart-price"><span>{{item.sale_price_in_naira}}</span></td>
                                        <!-- quantity -->
...
<script setup>
    ...
    var cart_items = computed(() => page.props.auth.user.art_items);
