                                            ...
                                            <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                                ...
                                                <tbody class="list form-check-all">
                                                    <tr>
                                                        ...
                                                        <td class="order_id"><a href="apps-ecommerce-order-overview.html" class="fw-medium link-primary">#TBS250001</a></td>
                                                        <td class="order_date">
                                                            22 Feb, 2023
                                                        </td>
                                                        ...
                                                        <td class="shop">
                                                            <a href="#!" class="text-reset"><img src="assets/images/companies/img-7.png" alt="" class="avatar-xxs rounded-circle me-1 shop-logo"> <span class="shop-name">Pich Fashion</span></a>
                                                        </td>
                                                        <td class="payment_method">COD</td>
                                                        <td class="amount"><span class="fw-medium">$109.00</span></td>
                                                        <td class="rating"><h5 class="fs-md fw-medium mb-0">-</h5></td>
                                                        <td class="status"><span class="badge bg-primary-subtle text-primary">New</span></td>
                                                        <td>
                                                            <ul class="d-flex gap-2 list-unstyled mb-0">
                                                                <li>
                                                                    <a href="apps-ecommerce-order-overview.html" class="btn btn-subtle-primary btn-icon btn-sm "><i class="ph-eye"></i></a>
                                                                </li>
                                                                <li>
