...
<script>
    ...
    const page = usePage();
    var five_categories = computed(() => page.props.five_categories);
    export default {
                                ...
                                <div class="tab-content m-img" id="productDetailsNavContent">
                                    <div class="tab-pane fade show active" id="nav-1" role="tabpanel"
                                        ...
                                        <div class="tp-product-details-nav-main-thumb">
                                            <img src="/src/assets/img/product/details/main/product-details-main-1.jpg"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="nav-2" role="tabpanel" aria-labelledby="nav-2-tab"
                                        tabindex="0">
                                        <div class="tp-product-details-nav-main-thumb">
                                            <img src="/src/assets/img/product/details/main/product-details-main-2.jpg"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="nav-3" role="tabpanel" aria-labelledby="nav-3-tab"
                                        tabindex="0">
                                        <div class="tp-product-details-nav-main-thumb">
                                            <img src="/src/assets/img/product/details/main/product-details-main-3.jpg"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="nav-4" role="tabpanel" aria-labelledby="nav-4-tab"
                                        tabindex="0">
                                        <div class="tp-product-details-nav-main-thumb">
                                            <img src="/src/assets/img/product/details/main/product-details-main-4.jpg"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="nav-5" role="tabpanel" aria-labelledby="nav-5-tab"
                                        tabindex="0">
                                        <div class="tp-product-details-nav-main-thumb">
                                            <img src="/src/assets/img/product/details/main/product-details-main-5.jpg"
                                                alt="">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-5 col-lg-6">
                            <div class="tp-product-details-wrapper">
                                ...
                                <div
                                    ...
                                    <h4 class="tp-product-details-countdown-title"><i
                                            class="fa-solid fa-fire-flame-curved"></i> Flash Sale end in: </h4>
                                    <div class="tp-product-details-countdown-time" data-countdown
                                ...
                                <div
                                    ...
                                    <img src="/src/assets/img/product/icons/payment-option.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <div class="col-xl-10">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <div class="tp-product-details-desc-content pt-25">
                                                                    ...
                                                                    <h3 class="tp-product-details-desc-title">Your world
                                                                        at a glance</h3>
                                                                    <p>With a slim design, a vibrant entertainment
                                                                        system, and <br> outstanding performance, the
                                                                        new Galaxy Tab A7 is a stylish new <br>
                                                                        companion for your life.Dive head-first into the
                                                                        things you love, <br> and easily share your
                                                                        favorite moments. Learn, explore, connect <br>
                                                                        and be inspired.</p>
                                                                </div>
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="tp-product-details-desc-thumb">
                                                                    <img src="/src/assets/img/product/details/desc/product-details-desc-1.jpg"
                                                                        alt="">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="tp-product-details-desc-item  pb-75">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-7">
                                                                <div class="tp-product-details-desc-thumb">
                                                                    <img src="/src/assets/img/product/details/desc/product-details-desc-2.jpg"
                                                                        alt="">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xl-12">
                                                                <div
                                                                    ...
                                                                    <img src="/src/assets/img/product/details/desc/product-details-desc-3.jpg"
                                                                        alt="">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="tp-product-details-review-list pr-110">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="tp-product-details-review-avater-thumb">
                                                                    <a href="#">
                                                                        <img src="/src/assets/img/users/user-3.jpg"
                                                                            alt="">
                                                                    </a>
                                                                </div>
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="tp-product-details-review-avater-thumb">
                                                                    <a href="#">
                                                                        <img src="/src/assets/img/users/user-2.jpg"
                                                                            alt="">
                                                                    </a>
                                                                </div>
                                                                <div class="tp-product-details-review-avater-content">
                            ...
                            <div class="swiper-wrapper">
                                    ...
                                    <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                            <a href="product-details.html">
                                                <img src="/src/assets/img/product/related/product-related-1.jpg" alt="">
                                            </a>
                                ...
                                <div class="swiper-slide">
                                    <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                            <a href="product-details.html">
                                                <img src="/src/assets/img/product/related/product-related-2.jpg" alt="">
                                            </a>
                                ...
                                <div class="swiper-slide">
                                    <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                            <a href="product-details.html">
                                                <img src="/src/assets/img/product/related/product-related-3.jpg" alt="">
                                            </a>
                                ...
                                <div class="swiper-slide">
                                    <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                            <a href="product-details.html">
                                                <img src="/src/assets/img/product/related/product-related-4.jpg" alt="">
                                            </a>
