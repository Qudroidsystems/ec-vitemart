...
<template>
    ...
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        ...
        <main>
            ...
            <!-- login area start -->
            <section class="tp-login-area pb-140 p-relative z-index-1 fix mt-40">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-6 col-lg-8">
                        <form @submit.prevent="submit" class="tp-login-wrapper">
                            ...
                            <div class="tp-login-input-wrapper">
                                ...
                                <div class="tp-login-input-box">
                                    ...
                                    <div class="tp-login-input-eye" @click = "toggleEye" id="password-show-toggle">
                                        <span id="open-eye" v-if = "closeEye" class="open-eye">
                                        ...
                                        <span id="close-eye" v-else class="open-close">
                            ...
                            <div class="tp-login-bottom p-4">
                                <PrimaryButton class="tp-login-btn w-100 ms-4" :class="{ 'opacity-25': form.processing}" :disabled="form.processing">
                                    Log in
                                </PrimaryButton>
                            </div>
                            </div>
