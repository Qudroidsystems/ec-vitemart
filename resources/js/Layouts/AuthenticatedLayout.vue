...
<template>
        ...
        <div class="cartmini__wrapper d-flex justify-content-between flex-column">
            ...
            <div class="cartmini__checkout">
                ...
                <div class="cartmini__checkout-btn">
                    ...
                    <Link :href="route('checkout')" class="tp-btn tp-btn-border w-100">checkout</Link>
                </div>
            </div>
        </div>
    </div>
    ...
    <header>
        <div class="tp-header-area p-relative z-index-11">
            <!-- header top start  -->
            <div class="tp-header-top black-bg p-relative z-index-1 p-2 d-none d-md-block">
                <div class="container">
                                ...
                                <div class="tp-header-top-menu d-flex align-items-center justify-content-end">
                                    ...
                                    <div class="tp-header-top-menu-item tp-header-setting">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <Link :href="route('wishlist')">My Profile</Link>
                                            </li>
                                            <li>
                                                <Link :href="route('cart')">Cart</Link>
                                            </li>
                                            <li>
                                                <!-- <Link :href="route('logout')" method = "post" :headers = "{'X-CSRF-TOKEN' : $('meta[name=csrf-token]').attr('value')}" as = "button">Logout</Link> -->
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-4 col-lg-3 col-md-8 col-6">
                            <div class="tp-header-main-right d-flex align-items-center justify-content-end">
                                <div class="tp-header-login d-none d-lg-block">
                                    <a to="/profile" class="d-flex align-items-center">
                                ...
                                <div class="tp-header-action d-flex align-items-center ml-50">
                                    <div class="tp-header-action-item d-none d-lg-block">
                                        <a to="/compare" class="tp-header-action-btn">
                                    ...
                                    <div class="tp-header-action-item d-none d-lg-block">
                                        <a to="/wishlist" class="tp-header-action-btn">
                                ...
                                <div class="main-menu menu-style-1">
                                    <nav class="tp-main-menu-content">
                                        <ul>
                                            ...
                                            <li>
                                                <Link :href = "route('category', {'slug' : 1})">Pharmacy</Link>
                                            </li>
...
<script setup>
    ...
    import mounted from '@/../../public/assets/js/main.js'

    const page = usePage();

    var categories = computed(() => {
        let categories = page.props.bag.categories;
        categories = categories.length > 8 ? categories.slice(0, 7) : categories;
        return categories;
    });
